...
class LDrawLoader extends Loader {
	...
	constructor( manager ) {
		...
		this.missingConditionalEdgeColorMaterial = new LDrawLoader.lDrawConditionalLineMaterial( { name: Loader.DEFAULT_MATERIAL_NAME, fog: true, color: 0xFF00FF } );
	...
	parseColorMetaDirective( lineParser ) {
		...
		if ( ! edgeMaterial ) {
			...
			const conditionalEdgeMaterial = new LDrawLoader.lDrawConditionalLineMaterial( {
